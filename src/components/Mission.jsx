    ...
    return (
        <div className='text-white max-w-[1240px] mx-auto grid md:grid-cols-2 py-14'>
            ...
            <div className='max-w-[1240px] mx-20 mt-4'>
                <form onSubmit='' className="bg-[#D7D8D7] rounded-xl space-y-6 p-6 text-xl">
                    <div className=''>
                        <label htmlFor="fullName" className="block text-[#000300]">
                            Full Name:
                        </label>
                        <input type="text" id="fullName" name="fullName" value='' onChange='' className="mt-1 p-2 border rounded-md w-full" required />
                    </div>
                    <div>
                        <label htmlFor="email" className="block text-[#000300]">
                            Email:
                        </label>
                        <input type="email" id="email" name="email" value='' onChange='' className="mt-1 p-2 border rounded-md w-full" required />
                    </div>
                    <div>
